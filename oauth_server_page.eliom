...
(* FIXME MOBILE *)
let%server css_name = !Oauth_server_config.css_name
...
(* FIXME MOBILE *)
let%server app_js = [Oauth_server_base.App.application_script ~defer:true ()]
let%client app_js = []
